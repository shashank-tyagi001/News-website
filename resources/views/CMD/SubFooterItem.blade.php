...
<form action={{route('SubFooterStore')}} method="POST" enctype="multipart/form-data">
    @csrf
  ...
  @endif
    ...
    <div class="row pt-5 pb-5 mt-2 mb-2">
        ...
        <div class="card p-4">
            <div class="row mb-3">
                <label for="fname" class="col-md-5">SubFooter name:</label>
                <input type="text" id="name" name="name" class="col-md-7">
            </div>

            <div class="row mb-3">
                <label for="status" class="col-md-5">Select FooterName:</label>
                <select id="footer_item_id" name="footer_item_id" class="col-md-7">
